...
export default function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-zinc-800 rounded-lg max-w-lg w-full relative z-[101]"
      ...
      >
        ...
        <div className="p-6">
          <h2 className="text-2xl font-semibold mb-2 text-gray-800 dark:text-zinc-100">
            {product.name}
          </h2>
          <p className="text-gray-600 dark:text-zinc-300 mb-4">
            {formatPrice(product.price)}
          </p>
          <p className="mb-6 text-gray-700 dark:text-zinc-200">
            {product.description}
          </p>
